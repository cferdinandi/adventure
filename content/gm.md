...
<p class="margin-bottom-small"><strong>The player is trying to climb a steep cliff.</strong> The Difficulty Rating is 4.</p>

- On an 4 or 5, they make it to the top.
- On a 6, they easily scale the cliff, and along the way, find a bottle of healing potion hidden in a nook on the cliff face.
- On a 2 or 3, they can't find a good foothold and can't climb higher than a foot or two, but nothing else happens to them.
...
<p class="margin-bottom-small">When creature deal damage to players, you if you don't want to roll for damage, you can use <em>average damage</em> instead.</p>
...
If multiple monsters deal damage to a player at the same time, take the highest damage die from among them and roll that.

Then add +1 to the damage for each monsters that dealt damage beyond the first.
...
{{<callout title="Example">}}
A horde of a dozen rats start biting your legs. They all have a D6WR damage die. The GM rolls one die, then adds 11 to the result, one for each rat beyond the first.

You cast _Wave of Thunder_, pushing the rats off you and doing 7 HP damage. Three of the rats lay still, knocked unconcious by the blast.
...
- Mash-up stories for a few different books are movies to create something unique.
...
The site [2-Minute Tabletop](https://2minutetabletop.com/) has an excellent collection of professional RPG maps. Many of them are free or "pay what you want."

If you're not confident in your drawing skills, this can be a really helpful resource.

#### Drawing Your Own Maps

Your maps don't have be professional quality to be fun and useful. If you want to learn how to draw your own maps, [Esper the Bard has an excellent YouTube series on creating fantasy maps](https://www.youtube.com/watch?v=EoKGIi-u7bA&list=PL4lwwEJ-yFaLLyVaHpqVeMUWSNe8NcXgG&index=2).

{{<details summary="Part 1: Map Basics">}}
<div class="fluid-vids"><iframe width="560" height="315" src="https://www.youtube.com/embed/EoKGIi-u7bA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
{{</details>}}

{{<details summary="Part 2: Mountains & Hills">}}
<div class="fluid-vids"><iframe width="560" height="315" src="https://www.youtube.com/embed/uu3KSKdFjaE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
{{</details>}}

{{<details summary="Part 3: Drawing Forests">}}
<div class="fluid-vids"><iframe width="560" height="315" src="https://www.youtube.com/embed/8keRu5dYAnc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
{{</details>}}

{{<details summary="Part 4: Lakes, Rivers & Swamps">}}
<div class="fluid-vids"><iframe width="560" height="315" src="https://www.youtube.com/embed/Y8ie1-7FXdY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
{{</details>}}

{{<details summary="Part 5: Deserts & Badlands">}}
<div class="fluid-vids"><iframe width="560" height="315" src="https://www.youtube.com/embed/vxWvKa2I9B0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
{{</details>}}

{{<details summary="Part 6: Unique Map Features">}}
<div class="fluid-vids"><iframe width="560" height="315" src="https://www.youtube.com/embed/C2eJX95Skyw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
{{</details>}}

{{<details summary="Bonus: The 1-Page Adventure Map" margin="true">}}
<div class="fluid-vids"><iframe width="560" height="315" src="https://www.youtube.com/embed/AeEUMCf0sys" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
{{</details>}}

#### Physical Maps

Depending on the age and interests of your players, it might be fun and interesting if you added a physical element to the game. You can create maps for locations by building them with blocks, or using toys and figurines for characters, monsters, and NPCS.
...
A player’s character carries over from one came to the next (if they want). They bring with them any skills and items they acquired on previous adventures.
...
- New Spells
- A 10 HP bump in Max/Current Health Points
- A second specialty
- New skills relevant to the adventure they just completed
- Increased combat skills, like ignoring Worst Roll on unweaponed attacks
- Extra damage dice (an additional D6 over what they currently have)
