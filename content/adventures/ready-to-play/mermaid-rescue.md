...
creatures: ['Mermaid', 'Sorcerer', 'Sorcerer Apprentice', 'Knights', 'Townspeople', 'Centaur', 'Yeti', 'Dwarf', 'Hydra', 'Crab', 'Wolf', 'Goblin', 'Cyclops']
scenery: ['Harbor', 'Castle', 'Tower', 'Dungeon', 'Cave', 'Cave Tunnel']
props: ['Food', 'Gold', 'Magic Hook', 'Torch']
...
{{%encounter order="b" title="Room 1" tips="The *Guide* might choose to let players discover useful items in the room."%}}
...
{{%encounter order="c" title="Room 2" tips="The small drafty door in this room leads down to the dungeon, where they'll discover the mermaid. It's OK if they don't find this until later in the story." difficulty="Up to three players: 4||Four or more players: 5" battle="Up to three players: 3 Brooms||Four or more players: 5 Brooms" villains="Broom: Difficulty - 3, Health - 1" success="The magical brooms successfully dealt with you, you look around and decide where to go next." failure="Unable to stop the brooms, you retreat to another space."%}}
...
{{%encounter order="a" title="The First Floor" tips="Players should use their skills and items to try to navigate the traps" difficulty="One or two players: 4||Three or four players: 5||Five or more players: 6" success="You successfully avoid the traps, and make your way up the stairs." failure="After an arrow hidden in the wall whizzes by overhead, you decide to come back later. You step back into the courtyard."%}}
...
{{%encounter order="b" title="The Second Floor"difficulty="One or two players: 4||Three or four players: 5||Five or more players: 6" battle="An Ogre" villains="Ogre: Difficulty 5, Health - 2" success="The ogre dealt with/avoided (for now), you dash up the stairs towards the third floor." failure="You retreat back down to the first floor, and consider your options."%}}
...
{{%encounter order="a" title="The Door to the Dungeon" tips="The *Guide* should encourage the players to head down the stairs."%}}
...
{{%encounter order="d" title="Door 2" tips="Players can try to slam the door shut before the yeti gets out instead of fighting him, if they want." difficulty="Up to three players: 5||Four or more players: 6" battle="Yeti" villains="Yeti: Difficulty - 5, Healthy - 2" success="Now that you've handled the yet, you can get back to locating the source of the cries for help."%}}
You open the door, and a yeti immediately charges towards you.
{{%/encounter%}}

{{%encounter order="e" title="The Sunken Room" success="You promise the mermaid you'll return with the magic key. Then you turn, and head back up the stairs. Time to visit the mines."%}}
...
In the tunnel, players will approach various forks. Let them choose which way to go.
...
{{%encounter order="b" title="The Ledge" tips="Every player must complete this challenge individually." difficulty="3" success="With the entire group over the ledge, you continue down the tunnel."%}}
...
{{%encounter order="c" title="The Hydra" difficulty="One or two players: 4||Three or four players: 5||Five or more players: 6" battle="The Hydra" villains="Hydra: Difficulty - 4, Health - 3" success="The hydra no longer a threat, you continue down the tunnel path."%}}
...
{{%encounter order="d" title="The Cliff" tips="Each player must complete this challenge individually. Resourceful players might consider heading back out to the forest to get a fallen branch to use as a bridge." difficulty="4" success="With the whole team successfully across, you continue on your way."%}}
...
{{%encounter order="e" title="Wolves" difficulty="3" battle="One or two players: 3 wolves||Three or four players: 5 wolves||Five or more players: 7 wolves" villains="Wolf: Difficulty - 3, Health - 1" success="Not wanting to stick around, you take off at a run down the tunnel."%}}
Suddenly, you hear howling from the tunnel to your left. Wolves!
{{%/encounter%}}

{{%encounter order="f" title="Underwater" tips="Players should try to get through the tunnel at the bottom. All players must complete this challenge individually. To heighten tension, if some players have made it and others have not yet, you can act as if the successful players don't know what happened to the rest of their group." difficulty="5" success="You're soaking wet and out of breath, but you made it. You keep walking into the darkness."%}}
...
{{%encounter order="g" title="The Giant Crab" difficulty="Up to three players: 5||Four or more players: 6" battle="A Giant Crab" villains="Giant Crab: Difficulty - 5||Health - 3" success="With the terrifying crab out of the way, you race out of the room and down the next tunnel. (*If applicable, don't forget to grab the hook.*)"%}}
...
(*For players who opted into the Old Man of the Sea's quest, among those artifacts is a magical hook.*)
...
{{%encounter order="h" title="The Torch of Hallows" tips="There's no die roll for this encounter. One players find it, they can leave." success="Now that you have the torch, there's only one thing left to do: get back out!"%}}
...
{{%encounter order="b" title="Goblin Attack" tips="" difficulty="4" battle="One or two players: 3 Goblins||Three or four players: 2 Goblins, 2 Goblin Warrior||Five or more players: 3 Goblins, 3 Goblin Warriors" villains="Goblin: Difficulty - 3, Health - 1||Goblin Warrior: Difficulty - 2, Health - 2" success="The goblins no longer a threat, you continue down the mountain pass"%}}
As you round the first bend in the pass, a flaming arrow lands in the dirt near your feet. Goblins!
{{%/encounter%}}

{{%encounter order="c" title="Cyclops" tips="If players fled the goblins, they may find themselves stuck between them and the cyclops. Savvy players can use the cyclops' single eye to their advantage." difficulty="5" battle="Up to three players: 1 Cyclops||Four or more players: 2 Cyclops" villains="Cyclops: Difficulty - 5, Health - 1" success="You run out of the mountain pass, hoping you never have to face a cyclops again. Ahead is a lush valley nestled between mountain peaks, divided by a wide, turbulent river. Ahead, you seen the crumbling ruins of a former outpost."%}}
...
{{%encounter order="a" title="The Bridge" tips="In addition to the tools and skills they already have, the surrounding area has many resources they can use to help them cross the river." difficulty="Up to three players: 5||Four or more players: 6" success="Safely across (barely), you head into the crumbling ruins of the outpost."%}}
...
{{%encounter order="c" title="Behind the Door" tips="The only option for this challenge is to battle. The sorcerer disappears after being defeated. It's unclear if he's *gone* gone or just vanished to return in a future adventure." battle="The Sorcerer" villains="Sorcerer: Difficulty - 6, Health - 3" success="As the final strike finds its target, the sorcerer's robes collapse to the floor in a pile. You run over and push them aside. He's gone. You rush over to the chest and open it. Inside is a gorgeous shell, a swirling mix of turquoise and coral-pink. You did it!"%}}
...
**If players opted into the Old Man of the Sea's side-adventure:** The old man has been sitting silently at the end of the dock. With barely a splash, he slides into the water.
...
- **If the players were successful:** "Thank you! We had believed this lost for good."
